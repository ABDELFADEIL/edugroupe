...
var personne2 = {
    ...
    presentation2 : ()=>{
        return "{nom :"  + personne2.nom +" prenom :" + personne2.prenom +"}";
    }
}
//Utilisation d'un objet litéral
    console.log(personne2.presentation2());
    //afficher la ville
    console.log(personne2.adresse.ville);
    //afficher la liste de ses compétences
    personne2.competences.forEach(elt=>console.log(elt));

//  Création de l'objet omer à partir de l'objet personne2
let omer = personne2;
//  Modification de l'état de l'objet Omer
    omer.prenom = "Omer";
//  Observations
console.log("personne 2 " + personne2.prenom); 
console.log("omer " + omer.prenom); 
...
class Personne5{
    ...
    //equals()
    equals(pers){
        if(!(pesr instanceof Personne5)){
            return false;
        }else{
            return this.#nom == pers.nom && this.prenom == pers.prenom 
                    && this.#age == pers.age && this.#adresse.equals(pers.adresse);
        }
    }
    // Héritage
